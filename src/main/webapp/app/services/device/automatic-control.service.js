(function() {
    ...
    function AutomaticControl ($http,HOST_GW) {
        ...
        function getScheduleInfo(deviceId, sector, phase, name) {
            return $http.get(HOST_GW + '/api/automatic-controls/schedule-nbh?deviceId=' + deviceId + '&sector=' + sector + '&phase=' + phase + '&name=' + name).then(function (response) {
                return response.data;
            });
        }
    }
