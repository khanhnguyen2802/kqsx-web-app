(function() {
    ...
    function Device ($http,HOST_GW) {
        var service = {
            ...
            refresh:refresh,
            getListCategoryByGwId: getListCategoryByGwId,
            addToGroupDevice: addToGroupDevice,
        };
        ...
        function getFullInfo(id) {
            return $http.get(HOST_GW + '/api/devices/' +id + '/get-full-info').then(function (response) {
                return response.data;
            });
        }
        ...
        function getListCategoryByGwId(gwId) {
            return $http.get(HOST_GW + '/api/devices/getListCategoryByGwId?id='+gwId).then(function(response) {
                return response.data;
            });
        }

        function addToGroupDevice(params) {
            return $http.get(HOST_GW + '/api/devices/addToGroup?' + params).then(function(response) {
                return response;
            });
        }
    }
