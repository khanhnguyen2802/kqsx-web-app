(function () {
    ...
    AutomaticCreateController.$inject = ['$rootScope', '$scope', '$state', '$http','$timeout',
        ...
        'DateTimeValidation', '$filter', 'AutomaticControl', '$window', 'Phase'];
    ...
    function AutomaticCreateController($rootScope, $scope, $state, $http,$timeout,
        ...
        $scope.placeholder = {
            season: $translate.instant("device.autoControl.placeholder.selectSeason"),
            area: $translate.instant("device.autoControl.placeholder.selectArea"),
            phase: $translate.instant("device.autoControl.placeholder.selectPhase"),
            groupDevice: $translate.instant("device.autoControl.placeholder.selectGroupDevice"),
            pumpSchedule: $translate.instant("device.autoControl.placeholder.selectPump"),
            waterLevel: $translate.instant("device.autoControl.placeholder.selectWaterLevel")
        }
        ...
        var areaCbb = {
            ...
            ngModel: [],
            options: [],
            placeholder: $scope.placeholder.area,
            orderBy: 'name,asc'
        };
        ComboBoxController.initFull($scope, areaCbb);
        ...
        var seasonCbb = {
            ...
            ngModel: [],
            options: [],
            placeholder: $scope.placeholder.season,
            orderBy: 'name,asc'
        };
        ...
        var phaseCbb = {
            ...
            ngModel: [],
            options: [],
            placeholder: $scope.placeholder.phase
        };
        ...
        var typeCbb = {
            ...
            ngModel: [],
            options: typeOptions,
            placeholder: $translate.instant("device.autoControl.typeSchedule.select")
        };
        ...
        var groupDeviceCbb = {
            ...
            ngModel: [],
            options: [],
            placeholder: $scope.placeholder.groupDevice
        };
        ...
        var pumpCbb = {
            ...
            ngModel: [],
            options: [],
            placeholder: $scope.placeholder.pumpSchedule
        };
        ComboBoxController.init($scope, pumpCbb);

        // lịch bơm
        var waterLevelOptions = [
            {id: 0, name: $translate.instant('device.autoControl.low')},
            {id: 1, name: $translate.instant('device.autoControl.full')}
        ];
        var waterLevelCbb = {
            id: 'waterLevelCbb',
            url: '',
            ...
            placeholder: $scope.placeholder.waterLevel
        };
        ...
        $scope.phaseChange = function () {
            $timeout(function () {
                ...
                Phase.getOne(phaseId).then(function (data) {
                    $("#startTime").parsley().reset();
                    $("#endTime").parsley().reset();

                    refreshDatePicker('startTime', data.beginDate);
                    refreshDatePicker('endTime', data.finishDate);
                    $scope.autoControl.startTime = data.beginDate;
                    $scope.autoControl.endTime = data.finishDate;
                })
            });
        };
