        ...
        $stateProvider
            ...
            .state('users-detail',{
                ...
                data: {
                    ...
                    parentLink: 'users',
                    authorities:['ROLE_SYSTEM_ADMIN','ROLE_SYSTEM_USER','ROLE_FARM_ADMIN', 'User_View'],
                    sideBarMenu: 'inventory'
                },
            ...
            .state('users-edit',{
                ...
                data: {
                    ...
                    parentLink: 'users',
                    authorities:['ROLE_SYSTEM_ADMIN','ROLE_SYSTEM_USER','ROLE_FARM_ADMIN', 'User_Update'],
                    sideBarMenu: 'inventory'
                },
            ...
            .state('privileges-detail',{
                ...
                data: {
                    ...
                    authorities:['ROLE_SYSTEM_ADMIN','ROLE_SYSTEM_USER','ROLE_FARM_ADMIN', 'Privilege_View'],
                    sideBarMenu: 'inventory'
                },
            ...
            .state('roles-detail',{
                ...
                data: {
                    pageTitle: 'admin.menu.roles',
                    parentLink: 'roles',
                    authorities:['ROLE_SYSTEM_ADMIN','ROLE_SYSTEM_USER','ROLE_FARM_ADMIN', 'Role_View'],
                    sideBarMenu: 'inventory'
                },
            ...
            .state('roles-edit',{
                ...
                data: {
                    pageTitle: 'admin.menu.roles',
                    parentLink: 'roles',
                    authorities:['ROLE_SYSTEM_ADMIN','ROLE_SYSTEM_USER','ROLE_FARM_ADMIN', 'Role_Update', 'Role_Delete'],
                    sideBarMenu: 'inventory'
                },
            ...
            .state('home',{
                parent: 'admin',
                url: '/',
                templateUrl: 'app/agri/dashboard/dashboard.html',
                ...
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load([
                            ...
                            'lazy_parsleyjs',
                            'lazy_KendoUI',
                            'app/agri/dashboard/dashboard.controller.js'
                        ]);
                    }]
                }
            })
            ...
            .state('dashboard-manager',{
                parent: 'admin',
                url: '/manager',
                templateUrl: 'app/agri/dashboard/dashboard.manager.html',
                ...
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load([
                            ...
                            'lazy_parsleyjs',
                            'lazy_KendoUI',
                            'app/agri/dashboard/dashboard.manager.controller.js'
                        ]);
                    }]
                }
            })
            .state('administration',{
                parent: 'admin',
                url: '/administration',
                templateUrl: 'app/agri/dashboard/administration.html',
                ...
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load([
                            'app/agri/dashboard/administration.controller.js'
                        ]);
                    }]
                }
            })
            ...
            .state('diagram',{
                parent: 'admin',
                url: '/diagram/{areaId}',
                templateUrl: 'app/agri/dashboard/diagram.html',
                ...
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load([
                            ...
                            'lazy_parsleyjs',
                            'lazy_KendoUI',
                            'app/agri/dashboard/diagram.controller.js'
                        ]);
                    }]
                }
            })
