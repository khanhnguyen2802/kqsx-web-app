(function(){
    ...
    RootController.$inject = [
        ...
        '$translate',
        '$window', 'Auth'];
    function RootController($rootScope, $scope, $state, $filter, $timeout, NotificationService, LogsService, User, ErrorHandle, $translate, $window, Auth) {
        ...
        $scope.timeDelayToCallUpdate = 60000;
