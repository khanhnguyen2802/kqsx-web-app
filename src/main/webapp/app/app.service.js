    ...
    .factory('apiData', ['$http','$q','HOST_GW',
        function($http, $q, HOST_GW) {
            var service = {
                ...
                getData:getData,
                genApi:genApi,
                genApiFull:genApiFull,
                genApiCustom:genApiCustom,
            ...
            function genApiFull(api, searchField, searchValue, size, typefilter, originparams, page, queryReplace,order) {
                var query = "/search?query=";
                if(queryReplace) {
                    query = queryReplace;
                }
            ...
            function genApiCustom(api, searchField, searchValue, size, typefilter, originparams, page, queryReplace,order) {
                var query = "/";
                if(queryReplace) {
                    query = queryReplace;
                }
